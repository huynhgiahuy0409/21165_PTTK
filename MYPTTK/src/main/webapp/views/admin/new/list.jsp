                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <!-- --trả về cho url name với value đồng thời merge value và model có cùng tên biến-- -->
                                    <input type="hidden" value="" id="page" name="page"/>
                                    <input type="hidden" value="" id="maxPageItem" name="maxPageItem"/>
                                    <input type="hidden" value="" id="sortName" name="sortName"/>
    ...
    function deleteNew(data) {
        $.ajax({
            ...
            success: function (result) {
                //reload lại trang danh sách
                window.location.href = "${NewURL}?type=list&maxPageItem=2&page=1&message=delete_success"; /*dispacth to admin-new */
            },
